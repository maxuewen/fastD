...
public abstract class ProcessButton extends FlatButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mProgressDrawable = (GradientDrawable) getDrawable(R.xml.rect_progress).mutate();
        mProgressDrawable.setCornerRadius(getCornerRadius());

        mCompleteDrawable = (GradientDrawable) getDrawable(R.xml.rect_complete).mutate();
        mCompleteDrawable.setCornerRadius(getCornerRadius());

        mErrorDrawable = (GradientDrawable) getDrawable(R.xml.rect_error).mutate();
